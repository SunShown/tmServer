...
public class CommentsDao {
	...
	public boolean addNewComment(String userId, String newsId, String comment) {
		try {
			sql= "INSERT INTO comments (newsId, userId, comment) VALUES (?, ?, ?);";
			return queryRunner.update(sql, newsId, userId, comment) > 0;
		} catch (SQLException e) {
			throw new RuntimeException(e);
		}
	}
